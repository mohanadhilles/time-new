...
<html dir="rtl" lang="ar">
	<head>
        ...
        <title><?php echo e((Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'PartTime')); ?> - <?php echo $__env->yieldContent('page-title'); ?></title>
        <link rel="icon" href="<?php echo e($logo.'/'.(isset($company_favicon) && !empty($company_favicon)?$company_favicon:'logo.png')); ?>" type="image" sizes="16x16">
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/web/css/bootstrap-rtl.min.css')); ?>">
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/web/css/animate.css')); ?>">
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/web/fontawesome5.10.2/css/all.css')); ?>">
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/web/plugins/owlslider/assets/owl.carousel.min.css')); ?>">		
    ...
    <div class="header-wrapper">
	        ...
	        <nav class="navbar navbar-expand-lg">
	            ...
	            <a class="navbar-brand" href="#">
	                <img src="<?php echo e(asset('assets/web/images/logo.png')); ?>" class="img-fluid d-none d-lg-inline">
	                <img src="<?php echo e(asset('assets/web/images/white-logo.png')); ?>" class="img-fluid d-lg-none d-xl-none">
	            </a>
						...
						<div class="details">
							<div class="join-us d-none d-lg-block wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
								<div class="row no-gutters mb-3 align-items-center">
									<div class="col-3">
										<img src="<?php echo e(asset('assets/web/images/statistices.png')); ?>" class="img-fluid" alt="">
									</div>
					...
					<div class="col-lg-6 text-center">
						<div class="video-wraper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
							<video class=""  autoplay="autoplay" loop="loop"  height="auto" width="100%" muted playsinline>
								<source src="<?php echo e(asset('assets/web/media/video.mp4')); ?>" type="video/mp4" />
              </video>
						</div>
						<div class="h-apps-links  wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".5s">
							<p>Soon</p>
							<a href="#" onclick="return false;" target="_blank">
								<img src="<?php echo e(asset('assets/web/images/icon-google.png')); ?>" class="img-fluid" alt="">
							</a>
							<a href="#" onclick="return false;"  target="_blank">
								<img src="<?php echo e(asset('assets/web/images/icon-apple.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
					</div>					
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="img wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<img src="<?php echo e(asset('assets/web/images/recruitment-solutions.png')); ?>" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-md-8">
						<div class="info mt-3">
							...
							<div class="actions wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".7s">
								<a href="https://partatime.typeform.com/to/zPyfQS" target="__blank" class="btn btn-pink ml-md-2">للباحثين عن فرص عمل بارتايم</a>
								<a href="https://partatime.typeform.com/to/zyXTV5" target="_blank" class="btn btn-blue-light">للمنشأت</a>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="features-section">
			<div class="container">
				...
				<div class="main-features-img text-center py-3 my-5  wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
					<img src="<?php echo e(asset('assets/web/images/companies-feautres-image.png')); ?>" class="img-fluid" alt="">
				</div>
					...
					<div class="row">
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/company-feature-1.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
						...
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".5s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/company-feature-2.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
						...
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".7s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/company-feature-3.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
		...
		<section class="features-section">
			<div class="container">
				...
				<div class="main-features-img text-center py-3 my-5 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
					<img src="<?php echo e(asset('assets/web/images/employees-feautres-image.png')); ?>" class="img-fluid mx-auto" alt="">
				</div>
				<div class="features-list">
					<div class="row">
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/employee-feature-1.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
						...
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".5s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/employee-feature-2.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
						...
						<div class="col-sm-4">
							<article class="feature wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".7s">
								<div class="img">
									<img src="<?php echo e(asset('assets/web/images/employee-feature-3.png')); ?>" class="img-fluid mx-auto" alt="">
								</div>
			...
			<div class="projects_slider owl-carousel">
				<div class="item">
					<div class="project-item">
						<img src="<?php echo e(asset('assets/web/images/projects/1.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
							...
							<div class="links">
								<a href="https://partatime.typeform.com/to/zPyfQS" target="__blank" class="btn btn-pink btn-sm">وظف بارتايم</a>
								<a href="https://partatime.typeform.com/to/zPyfQS" target="__blank" class="btn btn-blue-light btn-sm">انضم بارتايم</a>
							</div>
						</div>
					</div>
				</div>
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/2.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/3.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
							<h3 class="title">برج العنود</h3>
							<p class="city">الرياض</p>
							<p class="content">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما </p>
							<div class="links">
								<a href="https://partatime.typeform.com/to/zyXTV5"  target="__blank"class="btn btn-pink btn-sm">وظف بارتايم</a>
								<a href="https://partatime.typeform.com/to/zPyfQS"  target="__blank"class="btn btn-blue-light btn-sm">انضم بارتايم</a>
							</div>
						</div>
					</div>
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/4.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/5.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/6.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/7.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="item">
					<div class="project-item">
							<img src="<?php echo e(asset('assets/web/images/projects/8.png')); ?>" class="img-fluid" alt="">
						<div class="overlay d-flex justify-content-center flex-column">
				...
				<div class="experiences-list">
					<div class="d-flex justify-content-center align-items-center flex-wrap">
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/1.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/2.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/3.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/4.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/5.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/6.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/7.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/8.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/9.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/10.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
						<div class="experience wow zoomIn" data-wow-duration="1.5s" data-wow-delay=".3s">
							<a href="">
								<img src="<?php echo e(asset('assets/web/images/experiences/11.png')); ?>" class="img-fluid" alt="">
							</a>
						</div>
					</div>
				</div>
		...
		<!-- <section class="our-team-section">
			...
			<div class="team_slider owl-carousel wow fadeInUp mt-5" data-wow-duration="1.5s" data-wow-delay=".3s">
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/walled.png')); ?>" class="img-fluid" alt="">
						</div>
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/alaa.png')); ?>" class="img-fluid" alt="">
						</div>
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/mohanad.png')); ?>" class="img-fluid" alt="">
						</div>
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/hanady.png')); ?>" class="img-fluid" alt="">
						</div>
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/women.png')); ?>" class="img-fluid" alt="">
						</div>
						<h3>Rahaf Al Amri</h3>
						<p>Finance</p>
						<div class="social-team  text-center">
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/hani.png')); ?>" class="img-fluid" alt="">
						</div>
						<h3>Hani yousif</h3>
						<p>IT technology</p>
						<div class="social-team  text-center">
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/abeer.png')); ?>" class="img-fluid" alt="">
						</div>
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/suzan.png')); ?>" class="img-fluid" alt="">
						</div>
						<h3>Suzan Salem</h3>
						<p>Social media</p>
						<div class="social-team  text-center">
				...
				<div class="item">
					<div class="team-item">
						<div class="img">
							<img src="<?php echo e(asset('assets/web/images/team/ramy.png')); ?>" class="img-fluid" alt="">
						</div>
						<h3>Ramy Alshaer</h3>
						<p>UXUI Design</p>
						<div class="social-team  text-center">
					...
					<div class="row align-items-center">
						<div class="col-lg-4  col-md-6">
							<div class="w-about">
								<div class="f-logo">
									<a href="">
										<img src="<?php echo e(asset('assets/web/images/footer-logo.png')); ?>" class="img-fluid" alt="">
									</a>
								</div>
							...
							<div class="w-apps">
								...
								<div class="apps-links">
									<a href="" onclick="return false;" target="_blank" title="">
										<img src="<?php echo e(asset('assets/web/images/icon-google.png')); ?>" alt="">
									</a>
									<a href="" onclick="return false;" target="_blank" title="">
										<img src="<?php echo e(asset('assets/web/images/icon-apple.png')); ?>" alt="">
									</a>
								</div>
							</div>
						</div>
    ...
    <script  src="<?php echo e(asset('assets/web/js/jquery-3.4.1.min.js')); ?>"></script>
	...
	<script  src="<?php echo e(asset('assets/web/plugins/owlslider/owl.carousel.min.js')); ?>"></script>
...
</html><?php /**PATH /Users/mohanad/Documents/waleed/time/resources/views/app.blade.php ENDPATH**/ ?>